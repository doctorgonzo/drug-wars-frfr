...
public class ContractBannerUI : MonoBehaviour
{
    ...
    private void BuildUI()
    {
        ...
        _titleText   = AddRow(_panel.transform, "Title",   30, 18, FontStyles.Bold,    Color.white);
        _detailText  = AddRow(_panel.transform, "Detail",  26, 16, FontStyles.Normal,  Color.white);
        _paymentText = AddRow(_panel.transform, "Payment", 30, 22, FontStyles.Bold,    new Color(0.55f, 1f, 0.55f));
        _advanceText = AddRow(_panel.transform, "Advance", 22, 12, FontStyles.Italic,  new Color(0.85f, 0.85f, 0.7f));
